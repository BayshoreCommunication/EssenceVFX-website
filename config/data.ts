...
`,
...

  {
    ...
    descriptionTwo: `Blue Beetle 🪲 @sirjuliuscosplay
VFX by @cosplaypowers
—— Stats: 18,000+ reached`,
  },
...

  {
    ...
    descriptionOne:
      "Reed Richards comes to life! Huge thanks to @bewiseyc for the epic cosplay and @cosplaypowers for the cinematic VFX edit that had fans calling it everything from “Bro became balloon” to “Willy Wonka vibes.” This viral Fantastic Four edit hit 10.4K views!",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Bane vs Batman went viral! With @saadleup’s Bane and glowing-eyed Batman powered up by @cosplaypowers VFX, this showdown exploded with 1.8M views. Fans joked about Monster Energy sponsorships and shouted “Batman leveled up!” — making it one of the most talked-about cosplay edits online.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    subTitle: "Miguel O’Hara Returns",
    descriptionOne:
      "Spider-Man 2099 hits the checkout line! With @saadleup’s epic cosplay and @cosplaypowers full-scale production, this hilarious twist on Miguel O’Hara asking “Regular or organic?” racked up 46.5K views and 1,960+ likes — proving fans can’t get enough of Spider-Verse energy.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Azula enters with boss music vibes! @nimblenoor’s stunning cosplay, powered up by @cosplaypowers lightning VFX, turned Avatar fandom heads with 7,880 views. Fans lit up the comments: “SO badass!!” and “Literally FIRE.” A true cinematic take on the Fire Nation princess.",
  },
  {
    topInfo: {
      location: "USA",
  ...
  },
  {
    ...
    descriptionOne:
      "Spooky season never ends! @ki_ann’s ghostly cosplay, powered by @cosplaypowers supernatural VFX, brought spectral glows and wall-crawling illusions to life. Inspired by @deancgmvcon, this haunting edit gave fans chills — proving December can still feel like Halloween.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Miles Morales enters Squid Game! This parody mashup blended Marvel action with Netflix’s survival drama, dropping Spider-Verse energy into the deadly playground. First posted in 2021 and revived for Season 2 hype, the crossover had fans hooked all over again.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Thor strikes again! With @fazguardian’s powerful cosplay and @cosplaypowers lightning-charged VFX, Mjolnir crackled and fans went wild — shouting “Epic!!” and “Badass!!” The edit stormed to 29.5K views, proving the God of Thunder still reigns supreme in cosplay.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Miles Morales remastered! Directed by @director_ryanransom, starring @webslinger, and powered by @cosplaypowers, this revamped skit leveled up visuals, pacing, and cinematic flair. Fans called it “AWESOME” and “Very nicely done!” — proof that great cosplay ideas shine even brighter the second time.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Mister Negative invades GalaxyCon! With @cardboardcombat’s striking cosplay and @cosplaypowers bold VFX overlays, this edit nailed the eerie inverted look of Spider-Man’s dark foe. Fans praised the comic-book style and fresh spotlight on a rarely seen villain.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Miles Morales gets interviewed — but watch out for Storm! This playful skit mixed comedy, cosplay, and improv with @webslinger, @wannabesarcos, and @xoxtabigirlx0x. Fans loved the humor and crossover energy, calling it hilarious and demanding more.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Groot in a suit! @twitzaven’s stylish twist on the Guardians hero, edited by @cosplaypowers, turned heads at AniMATE! Columbus. With Rocket in hand and a tree-lined backdrop, this cosplay was both classy and true to character — a fan-favorite convention moment.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Starfire vs Black Manta! @broisalove_ and @star.gazer.cosplay brought DC’s universe to life in this cinematic face-off, with @cosplaypowers adding glowing blasts and battle visuals. Fans called it a powerful cosplay moment, praising both the energy and bold character portrayals.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Ant-Man shrinks into breakfast! @herbtziu’s hilarious cosplay skit, edited by @cosplaypowers, put Marvel’s tiniest hero inside a cereal bowl for a bite-sized laugh. Fans loved the playful twist, calling it pure Marvel parody energy.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Deadpool & Spider-Man in Marvel Zombies! @shobson2080 and @webslinger bring chaotic banter to the apocalypse, with @cosplaypowers edits, @mikeprevitvo voiceover, and @agustin_guilas sound. Fans loved Part 1’s mix of comedy and VFX — and are already demanding Part 2.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Black Canary unleashes the Sonic Scream! @hannahdove_ stunned in this cosplay skit, powered by @cosplaypowers and @essencecartoon VFX. The cinematic edit gave fans a live-action glimpse of Canary’s legendary power — and they loved every second.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Magneto commands the skies! @ol_saltbeard_c70 embodied the Master of Magnetism in this cinematic collab, with @cosplaypowers VFX, @thisguyaudio sound, and @ververherseen compositing. Missiles soared, fans shouted “Dope” and “Awesome,” and the edit felt straight out of an X-Men film.",
  },
  {
    topInfo: {
      location: "USA",
    ...
    descriptionOne:
      "Spider-Man 2 comes to life! @ethanguzman.ae suited up as Spidey while @cosplaypowers and @essencecartoon turned the con floor into a PS5-level with glowing portals, green hazards, and cinematic vibes. Fans said it looked like a real cutscene — and they weren’t wrong.",
  },
];
...
export const gallerySilderData = [
  ...
  { url: "/assets/gallery-img/mr-fantasticxx.png" },
